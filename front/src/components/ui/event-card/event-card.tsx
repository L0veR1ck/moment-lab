...
function EventCard({ urlImg, titleCard, description, path, imgPosition }: EventCardProps) {
    return (
        <div className="h-[700px] w-[544px] flex flex-col shadow-xl rounded-[16px] border border-[var(--color-blue)]/10 ">
            <div className={`h-[100%] flex-[2.2] rounded-t-[16px] bg-cover bg-no-repeat ${urlImg} ${imgPosition}`} />
