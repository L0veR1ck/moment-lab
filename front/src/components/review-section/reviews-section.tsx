        ...
        <section className="flex flex-col w-full py-[64px] max-w-[1280px]">
            ...
            <Carousel
                ...
                renderArrowPrev={(onClickHandler, hasPrev, label) => (
                    hasPrev && (
                        <button
                            ...
                            title={label}
                            className="absolute -left-15 group top-1/2 -translate-y-1/2 z-10 w-12 h-12 border border-[var(--color-blue)]/55 hover:border-[var(--color-blue)] rounded-full flex items-center justify-center shadow transition"
                        >
                ...
                renderArrowNext={(onClickHandler, hasNext, label) => (
                    hasNext && (
                        <button
                            onClick={onClickHandler}
                            title={label}
                            className="absolute -right-15 group top-1/2 -translate-y-1/2 z-10 w-12 h-12 border border-[var(--color-blue)]/55 hover:border-[var(--color-blue)] rounded-full flex items-center justify-center shadow transition"
                        >
                            <svg fill="none" viewBox="0 0 24 24" strokeWidth="2" className="w-6 h-6 stroke-[var(--color-blue)]/55 group-hover:stroke-[var(--color-blue)] transition">
                ...
                renderIndicator={(onClickHandler, isSelected, index, label) => {
                    const base = "inline-block w-3 h-3 mx-1 rounded-full cursor-pointer";
                    return (
                        <li
                            className={
