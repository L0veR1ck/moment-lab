    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route
          ...
          element={<CorporateEventScreen />}
        />
        <Route
          path={ROUTES.PERSONAL_IQ_GAME}
          element={<PersonalIqGameScreen />}
        />
        <Route
          path={ROUTES.LIVE_ACTION_QUESTS}
          element={<LiveActionQuestsScreen />}
        />
        <Route
          path={ROUTES.ART_TEAM_BUILDING}
          element={<ArtTeamBuildingScreen />}
        />
        ...
        <Route
          ...
          element={<IntellectualGamesScreen />}
        />
        <Route
          path={ROUTES.ENTERTAINMENT_GAMES}
          element={<EntertainmentGamesScreen />}
        />
