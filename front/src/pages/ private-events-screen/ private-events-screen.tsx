            ...
            <main className='flex flex-col items-center'>
                <section className="flex flex-wrap justify-center gap-[32px] pt-[64px] pb-[32px] max-w-[1280px]">
                    <div className="relative">
                        <img 
                                src={littleDiamond} 
                                className="absolute top-2/5 left-[-230px] transform -translate-y-1/2 -mt-12" 
                                alt="" 
                        />
                        <h1 className="font-semibold text-[64px] text-[var(--color-dark-blue)]">Частные мероприятия</h1>
                    </div>
