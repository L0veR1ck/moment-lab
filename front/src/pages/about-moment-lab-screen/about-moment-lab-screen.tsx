    ...
    return (
        <div className='flex flex-col items-center'>
            ...
            <main className="flex flex-col items-center w-full max-w-[1280px]">
                <section className="flex justify-between pt-[64px] pb-[32px] h-[calc(100vh-180px)] w-full">
                    ...
                    <div className="flex-2 rounded-l-[15px] bg-cover bg-no-repeat bg-[url(./src/assets/about-screen/team.png)] bg-position-[60%]" />
                </section>
