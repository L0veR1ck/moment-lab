...
function ArtTeamBuildingScreen() {
  ...
  const personalIqGameData = {
    section_1: {
      ...
      mainAnnotation:
        "Приготовься раскрыть свой творческий потенциал и объединить усилия с командой ради общего успеха. Откажись от шаблонных подходов и погружайся в атмосферу вдохновения!",
